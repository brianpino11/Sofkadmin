...
class _ConversationScreenState extends State<ConversationScreen> {
  ...
  void initState() {
    ...
    conversationModel.setMessage("¿Quieres conocerme?");
    conversationModel.setSendByMe(false);
    conversations.add(conversationModel);

    ConversationModel conversationModel2 = new ConversationModel();
    conversationModel2.setMessage("Hemos creado este espacio para que puedas interactuar con nostros. Hazme preguntas, en el trascurso del dia te respondere.");
    ...
    conversationModel3.setMessage("Te gusta lo que trabajas?");
